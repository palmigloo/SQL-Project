...
# Requirement 1 : Identifying repeat visitors 
...
where created_at >= '2021-01-01' and created_at < '2021-11-01' 
...
on uwns.user_id = ws.user_id 
   and created_at >= '2021-01-01' and created_at < '2021-11-01' 
...
# Requirement 2: Analyzing average time between repeat session

# Step 1: Get all the non-repeat session 
drop table user_w_nonrepeat_session;
create temporary table user_w_nonrepeat_session_1
select user_id,
       website_session_id,
       created_at
from website_sessions
where created_at >= '2021-01-01' and created_at < '2021-11-03' 
      and is_repeat_session = 0 ;

# Step 2: Find out the second session_id 
drop table user_w_repeat_session;
create temporary table user_w_repeat_session_1
select uwns.user_id,
       uwns.website_session_id as new_session_id,
       uwns.created_at as new_session_created_at,
       ws.website_session_id,
       ws.created_at 
from user_w_nonrepeat_session_1 uwns 
inner join website_sessions ws 
on uwns.user_id = ws.user_id 
   and ws.created_at >= '2021-01-01' and ws.created_at < '2021-11-01' 
   and is_repeat_session = 1  
   and uwns.website_session_id < ws.website_session_id ;

# Step 3: Find out the diff between 1st and 2nd session of each user 
...
# Requirement 3: Analyzing repeat channel behavior 
select case
...
from website_sessions
where created_at >= '2021-01-01' and created_at < '2021-11-05'
group by 1;

# Requirement 4: Analyzing new and repeat conversion rate 
...
where ws.created_at >= '2021-01-01' and ws.created_at < '2021-11-08'
group by 1
