...
# Requirement 1 : Analysing channel porfolio 
...
where created_at > '2021-08-22' and created_at < '2021-11-29'
...
from website_sessions 
where created_at > '2021-08-22' and created_at < '2021-11-30'
AND utm_campaign = 'nonbrand'
group by 1;

# Requirement 3: Cross-channel bid optimization 
select device_type,
       utm_source,
...
where ws.created_at > '2021-08-22' and ws.created_at < '2021-09-19'
AND utm_campaign = 'nonbrand'
group by 1,2 ;
...
from website_sessions
where created_at > '2021-11-04' and created_at < '2021-12-22'
AND utm_campaign = 'nonbrand'
group by 1;

# Requirement 5: Analysing direct,brand-driven traffic 
